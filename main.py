# main.py  ── solo líneas modificadas marcadas con  # ← CHANGED
import cv2
import yaml
...
from src.visualization.dashboard_renderer import DashboardRenderer  # ← CHANGED
...
def main():
    ...
    renderer  = DashboardRenderer()                                 # ← CHANGED
    ...
    while cap.isOpened():
        ...
        output  = renderer.render(frame, persons)  # dashboard completo
